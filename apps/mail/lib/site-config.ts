const TITLE = 'AdminiMail';
const DESCRIPTION =
  'Experience email the way you want with AdminiMail - the first open source email app that puts your privacy and safety first.';
